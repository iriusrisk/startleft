...
from slp_abacus.slp_abacus.objects.diagram_objects import DiagramTrustZone
from slp_abacus.slp_abacus.parse.transformers.default_trustzone_transformer import DefaultTrustZoneTransformer
from slp_abacus.tests.util.builders import build_component, build_diagram, build_components
...
class TestDefaultTrustZoneTransformer:
    @patch('slp_abacus.slp_abacus.parse.transformers.default_trustzone_transformer.TrustZoneRepresentationCalculator')
