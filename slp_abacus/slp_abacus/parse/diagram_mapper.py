...
from slp_abacus.slp_abacus.objects.diagram_objects import Diagram, DiagramComponent, DiagramTrustZone
...
class DiagramMapper:
    def __init__(self, diagram: Diagram, mapping: AbacusMapping):
        self._diagram: Diagram = diagram
        self._mapping: AbacusMapping = mapping
