...
from slp_visio.slp_visio.representation.visio.zone.irregular_zones import irregular_zones
from slp_visio.slp_visio.representation.visio.zone.regular_zones import regular_zones
