...
from slp_visio.objects.diagram_factories import DiagramComponentFactory, DiagramConnectorFactory
from slp_visio.objects.diagram_objects import DiagramComponent, DiagramConnector
