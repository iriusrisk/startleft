...
class TestVisioProcessor:
    ...
    def test_manually_modified_connectors(self):
        ...
        check_otm_dataflow(otm, 0, '1', '41', False)
        check_otm_dataflow(otm, 1, '6', '46', False)
        check_otm_dataflow(otm, 2, '11', '51', False)
        check_otm_dataflow(otm, 3, '16', '56', False)
        check_otm_dataflow(otm, 4, '21', '61', False)
        check_otm_dataflow(otm, 5, '26', '66', False)
        check_otm_dataflow(otm, 6, '31', '71', False)
        check_otm_dataflow(otm, 7, '36', '76', False)
        check_otm_dataflow(otm, 8, '97', '107', False)
        check_otm_dataflow(otm, 9, '102', '112', False)
        check_otm_dataflow(otm, 10, '120', '125', False)
