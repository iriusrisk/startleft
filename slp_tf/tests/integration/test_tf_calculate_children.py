...
class TestTerraformCalculateChildren:
    ...
    def test_aws_parent_children_components(self, mapping_file):
        ...
        terraform_file = get_byte_data(test_resource_paths.terraform_aws_parent_children_components)
    ...
    @pytest.mark.parametrize('mapping_file', [
        pytest.param(get_byte_data(tf_mapping_children_by_type_name), id="by {type}.{name}"),
        pytest.param(get_byte_data(tf_mapping_children_by_full_path_attribute), id="by full path attribute"),
        pytest.param(get_byte_data(tf_mapping_children_by_name), id="by {name}")])
    def test_define_children_relationship(self, mapping_file):
        ...
        tf_file = get_byte_data(test_resource_paths.terraform_aws_parent_children_components)
