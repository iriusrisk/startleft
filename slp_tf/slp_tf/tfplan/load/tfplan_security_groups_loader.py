...
from slp_tf.slp_tf.tfplan.tfplan_objects import TfplanSecurityGroup, TfplanOTM
from slp_tf.slp_tf.tfplan.load.resource_data_extractors import security_groups_ids_from_ingress_property, \
...
class TfplanSecurityGroupsLoader:
