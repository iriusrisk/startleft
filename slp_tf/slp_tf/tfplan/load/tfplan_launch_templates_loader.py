from slp_tf.slp_tf.tfplan.tfplan_objects import TfplanOTM, TfplanLaunchTemplate
from slp_tf.slp_tf.tfplan.load.resource_data_extractors import security_groups_ids_from_network_interfaces
