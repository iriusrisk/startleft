...
class TerraformTrustzoneMapper:
...
class TerraformComponentMapper:
    def __init__(self, mapping):
        self.mapping = mapping
        self.source = None
        self.id_map = {}
...
class TerraformDataflowNodeMapper:
    def __init__(self, mapping):
        self.mapping = mapping
        self.id_map = {}
...
class TerraformDataflowMapper:
    ...
    def run(self, source_model, id_dataflows):
        ...
        for source_obj in source_objs:
            ...
            source_mapper = TerraformDataflowNodeMapper(self.mapping["source"])
            destination_mapper = TerraformDataflowNodeMapper(self.mapping["destination"])
