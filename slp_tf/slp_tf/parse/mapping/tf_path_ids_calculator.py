...
def is_trustzone_parent(component: OtmComponent):
    return component.parent_type == 'trustZone'


class TerraformPathIdsCalculator:

    def __init__(self, components: [OtmComponent], id_generator):
    ...
    def __calculate_path_id(self, component: OtmComponent) -> Optional[str]:
    ...
    def __get_parent_path_id(self, component: OtmComponent) -> Optional[str]:
