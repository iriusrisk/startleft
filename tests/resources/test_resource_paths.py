...
terraform_aws_singleton_components_unix_line_breaks = os.path.dirname(__file__) + '/terraform/aws_singleton_components_unix_line_breaks.tf'
terraform_aws_singleton_components_dos_line_breaks = os.path.dirname(__file__) + '/terraform/aws_singleton_components_dos_line_breaks.tf'
terraform_aws_singleton_components_classic_macos_line_breaks = os.path.dirname(__file__) + '/terraform/aws_singleton_components_classic_macos_line_breaks.tf'
