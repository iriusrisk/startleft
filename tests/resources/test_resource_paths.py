...
boundary_tz_and_default_tz = path + '/visio/boundary-tz-and-default-tz.vsdx'
overlapped_boundary_tzs = path + '/visio/overlapped-boundary-tzs.vsdx'
multiple_pages_diagram = path + '/visio/multiple-pages-diagram.vsdx'
# mapping
