...
class TestOtmProjectService:
    ...
    def test_from_iac_valid_yaml_mapping_files_provided_ok(self):
        ...
        otm_project = OtmProject.from_iac_file(project_id, project_name, Provider.CLOUDFORMATION, iac_file,
    ...
    def test_from_iac_invalid_yaml_iac_file_error_jmes_error(self):
        ...
        with raises(JMESPathTypeError):
            OtmProject.from_iac_file(project_id, project_name, Provider.CLOUDFORMATION, iac_file)
    ...
    def test_from_iac_invalid_mapping_files_error_invalid_schema(self):
        ...
        with raises(MappingFileSchemaNotValidError):
            OtmProject.from_iac_file(project_id, project_name, Provider.CLOUDFORMATION, iac_file, custom_iac_mapping_files)
    ...
    def test_from_iac_file_to_otm_stream_ok(self):
        ...
        otm_project = OtmProject.from_iac_file_to_otm_stream(project_id, project_name, Provider.CLOUDFORMATION, iac_file, None)
    ...
    def test_from_iac_file_otm_stream_invalid_file_ok(self):
        ...
        with raises(JMESPathTypeError):
            OtmProject.from_iac_file_to_otm_stream(project_id, project_name, Provider.CLOUDFORMATION, iac_file, None)
