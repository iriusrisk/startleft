...
class TestOtmControllerDiagramVisio:
    ...
    @responses.activate
    @patch('startleft.startleft.validators.visio_validator.VisioValidator.validate')
    ...
    @responses.activate
    @patch('startleft.startleft.diagram.external_diagram_to_otm.ExternalDiagramToOtm.run')
    ...
    @responses.activate
    @patch('startleft.startleft.validators.generic_mapping_validator.GenericMappingValidator.validate')
    ...
    @responses.activate
    @patch('startleft.startleft.mapping.mapping_file_loader.MappingFileLoader.load')
