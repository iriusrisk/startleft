...
class TestCliParseDiagram:
    ...
    def test_parse_diagram_file_ok(self):
        ...
        """
        runner = CliRunner()
        output_file_name = "test_parse_diagram_file_ok"
        ...
        with runner.isolated_filesystem():
            ...
            assert validate_and_diff_otm(output_file_name, OTM_AWS_SHAPES_EXPECTED, self.excluded_regex) == {}
    ...
    def test_parse_diagram_with_custom_mapping_file_ok(self):
        ...
        """
        runner = CliRunner()
        output_file_name = "test_parse_diagram_with_custom_mapping_file_ok.otm"
        ...
        with runner.isolated_filesystem():
            ...
            assert result.exit_code == 0
            # and validate and compare otm files
            assert validate_and_diff_otm(output_file_name, OTM_AWS_WITH_TZ_AND_VPC, self.excluded_regex) == {}
