...
PROCESSORS = [
    {'name': 'slp_base', 'type': 'processor',
     'forbidden_dependencies': ['startleft', 'slp_cft', 'slp_tf', 'slp_tfplan', 'slp_visio', 'slp_mtmt']},
    {'name': 'slp_cft', 'type': 'processor', 'provider_type': 'CLOUDFORMATION',
     'forbidden_dependencies': ['startleft', 'slp_tf', 'slp_tfplan', 'slp_visio', 'slp_mtmt']},
    {'name': 'slp_tf', 'type': 'processor', 'provider_type': 'TERRAFORM',
     'forbidden_dependencies': ['startleft', 'slp_cft', 'slp_tfplan', 'slp_visio', 'slp_mtmt']},
    {'name': 'slp_tfplan', 'type': 'processor', 'provider_type': 'TFPLAN',
     'forbidden_dependencies': ['startleft', 'slp_cft', 'slp_tf', 'slp_visio', 'slp_mtmt']},
    {'name': 'slp_visio', 'type': 'processor', 'provider_type': 'VISIO',
     'forbidden_dependencies': ['startleft', 'slp_cft', 'slp_tf', 'slp_tfplan', 'slp_mtmt']},
    {'name': 'slp_visio', 'type': 'processor', 'provider_type': 'LUCID',
     'forbidden_dependencies': ['startleft', 'slp_cft', 'slp_tf', 'slp_tfplan', 'slp_mtmt']},
    {'name': 'slp_mtmt', 'type': 'processor', 'provider_type': 'MTMT',
     'forbidden_dependencies': ['startleft', 'slp_cft', 'slp_tf', 'slp_tfplan', 'slp_visio']}
]
