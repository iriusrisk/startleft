...
PROCESSORS = [
        ...
        {'name': 'slp_cft',  'type': 'processor', 'provider_type': 'CLOUDFORMATION', 'forbidden_dependencies': ['startleft', 'slp_tf', 'slp_mtmt']},
        {'name': 'slp_tf',   'type': 'processor', 'provider_type': 'TERRAFORM',      'forbidden_dependencies': ['startleft', 'slp_cft', 'slp_mtmt']},
        {'name': 'slp_mtmt', 'type': 'processor', 'provider_type': 'MTMT',           'forbidden_dependencies': ['startleft', 'slp_cft', 'slp_tf']}
]
