...
from startleft.iac.mapping.mappers.component_mapper import ComponentMapper
from startleft.iac.mapping.mappers.dataflow_mapper import DataflowMapper
from startleft.iac.mapping.mappers.trustzone_mapper import TrustzoneMapper
...
class IacToOtmTransformer:
    ...
    def __generate_dataflow_from_hub(self, origin_dataflow, target_dataflow, additional_tags=None):
        ...
        dataflow = DataflowMapper.create_core_dataflow(df_name, source_obj, source_resource_id, destination_resource_id)
