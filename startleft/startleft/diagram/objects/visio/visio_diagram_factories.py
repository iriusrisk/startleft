...
from startleft.startleft.diagram.objects.diagram_factories import DiagramComponentFactory, DiagramConnectorFactory
from startleft.startleft.diagram.objects.diagram_objects import DiagramComponent, DiagramConnector
